...
--------------------------------
-- 
-- @function [parent=#Director] loadVPMatrices 
-- @param self
-- @param #mat4_table view
-- @param #mat4_table projection
-- @return Director#Director self (return value: cc.Director)
...
--------------------------------
-- 
-- @function [parent=#Director] getVPMat 
-- @param self
-- @return VPMat#VPMat ret (return value: cc.VPMat)
