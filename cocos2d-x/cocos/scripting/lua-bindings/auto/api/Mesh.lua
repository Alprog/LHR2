...
--------------------------------
-- @overload self, array_table, array_table, array_table, array_table, array_table, array_table         
...
--------------------------------
-- 
-- @function [parent=#Mesh] combine 
-- @param self
-- @param #array_table meshes
