...
int lua_cocos2dx_3d_Animation3D_getName(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_Animation3D_getName'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_Animation3D_getName'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.Animation3D:getName",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_Animation3D_getName'.",&tolua_err);
#endif
...
int lua_cocos2dx_3d_Animation3D_loadAnimations(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    {
        std::string arg0;
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "cc.Animation3D:loadAnimations");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_Animation3D_loadAnimations'", nullptr);
            return 0;
        }
        cocos2d::Vector<cocos2d::Animation3D *> ret = cocos2d::Animation3D::loadAnimations(arg0);
        ccvector_to_luaval(tolua_S, ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "cc.Animation3D:loadAnimations",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_Animation3D_loadAnimations'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_cocos2dx_3d_Animation3D(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Animation3D");
        ...
        tolua_function(tolua_S,"getName",lua_cocos2dx_3d_Animation3D_getName);
        ...
        tolua_function(tolua_S,"loadAnimations", lua_cocos2dx_3d_Animation3D_loadAnimations);
...
int lua_cocos2dx_3d_Mesh_getGLProgramState(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_Mesh_getGLProgramState'", nullptr);
            return 0;
        }
...
int lua_cocos2dx_3d_Mesh_getMeshIndexData(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_Mesh_getMeshIndexData'", nullptr);
            return 0;
        }
...
int lua_cocos2dx_3d_Mesh_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
#if COCOS2D_DEBUG >= 1
    ...
    do 
    {
        ...
        {
            std::string arg0;
            ok &= luaval_to_std_string(tolua_S, 2,&arg0, "cc.Mesh:create");
            if (!ok) { break; }
            cocos2d::MeshIndexData* arg1;
            ok &= luaval_to_object<cocos2d::MeshIndexData>(tolua_S, 3, "cc.MeshIndexData",&arg1, "cc.Mesh:create");
            if (!ok) { break; }
            cocos2d::Mesh* ret = cocos2d::Mesh::create(arg0, arg1);
    ...
    do 
    {
        if (argc == 3)
        {
            ...
            ok &= luaval_to_object<cocos2d::MeshIndexData>(tolua_S, 3, "cc.MeshIndexData",&arg1, "cc.Mesh:create");
            if (!ok) { break; }
            cocos2d::MeshSkin* arg2;
            ok &= luaval_to_object<cocos2d::MeshSkin>(tolua_S, 4, "cc.MeshSkin",&arg2, "cc.Mesh:create");
            if (!ok) { break; }
    ...
    do 
    {
        if (argc == 4)
        {
            ...
            ok &= luaval_to_std_vector_float(tolua_S, 2, &arg0, "cc.Mesh:create");
            if (!ok) { break; }
            std::vector<float, std::allocator<float> > arg1;
            ok &= luaval_to_std_vector_float(tolua_S, 3, &arg1, "cc.Mesh:create");
            if (!ok) { break; }
            std::vector<float, std::allocator<float> > arg2;
            ok &= luaval_to_std_vector_float(tolua_S, 4, &arg2, "cc.Mesh:create");
            if (!ok) { break; }
            std::vector<unsigned short, std::allocator<unsigned short> > arg3;
            ok &= luaval_to_std_vector_ushort(tolua_S, 5, &arg3, "cc.Mesh:create");
            if (!ok) { break; }
    ...
    ok  = true;
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d", "cc.Mesh:create",argc, 4);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_Mesh_create'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_3d_Mesh_combine(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 2)
    {
        cocos2d::Vector<cocos2d::Mesh *> arg0;
        std::vector<float, std::allocator<float> > arg1;
        ok &= luaval_to_ccvector(tolua_S, 2, &arg0, "cc.Mesh:combine");
        ok &= luaval_to_std_vector_float(tolua_S, 3, &arg1, "cc.Mesh:combine");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_Mesh_combine'", nullptr);
            return 0;
        }
        cocos2d::Mesh* ret = cocos2d::Mesh::combine(arg0, arg1);
        object_to_luaval<cocos2d::Mesh>(tolua_S, "cc.Mesh",(cocos2d::Mesh*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "cc.Mesh:combine",argc, 2);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_Mesh_combine'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_cocos2dx_3d_Mesh(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Mesh");
        ...
        tolua_function(tolua_S,"create", lua_cocos2dx_3d_Mesh_create);
        tolua_function(tolua_S,"combine", lua_cocos2dx_3d_Mesh_combine);
    tolua_endmodule(tolua_S);
...
int lua_cocos2dx_3d_MeshIndexData_setPrimitiveType(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshIndexData* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"cc.MeshIndexData",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::MeshIndexData*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshIndexData_setPrimitiveType'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_uint32(tolua_S, 2,&arg0, "cc.MeshIndexData:setPrimitiveType");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshIndexData_setPrimitiveType'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshIndexData:setPrimitiveType",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshIndexData_setPrimitiveType'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_3d_MeshIndexData_getId(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshIndexData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshIndexData_getId'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshIndexData_getId'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshIndexData:getId",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshIndexData_getId'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_3d_MeshIndexData_getPrimitiveType(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshIndexData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshIndexData_getPrimitiveType'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshIndexData_getPrimitiveType'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshIndexData:getPrimitiveType",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshIndexData_getPrimitiveType'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_3d_MeshIndexData_getMeshVertexData(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshIndexData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshIndexData_getMeshVertexData'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshIndexData_getMeshVertexData'", nullptr);
            return 0;
        }
        const cocos2d::MeshVertexData* ret = cobj->getMeshVertexData();
        object_to_luaval<cocos2d::MeshVertexData>(tolua_S, "cc.MeshVertexData",(cocos2d::MeshVertexData*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshIndexData:getMeshVertexData",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshIndexData_getMeshVertexData'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_3d_MeshIndexData_getIndexBuffer(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshIndexData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshIndexData_getIndexBuffer'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshIndexData_getIndexBuffer'", nullptr);
            return 0;
        }
        const cocos2d::IndexBuffer* ret = cobj->getIndexBuffer();
        object_to_luaval<cocos2d::IndexBuffer>(tolua_S, "cc.IndexBuffer",(cocos2d::IndexBuffer*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshIndexData:getIndexBuffer",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshIndexData_getIndexBuffer'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_3d_MeshIndexData_setId(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshIndexData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshIndexData_setId'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "cc.MeshIndexData:setId");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshIndexData_setId'", nullptr);
            return 0;
        }
        cobj->setId(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshIndexData:setId",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshIndexData_setId'.",&tolua_err);
#endif

    return 0;
}
static int lua_cocos2dx_3d_MeshIndexData_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (MeshIndexData)");
    return 0;
}

int lua_register_cocos2dx_3d_MeshIndexData(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"cc.MeshIndexData");
    tolua_cclass(tolua_S,"MeshIndexData","cc.MeshIndexData","cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,"MeshIndexData");
        tolua_function(tolua_S,"setPrimitiveType",lua_cocos2dx_3d_MeshIndexData_setPrimitiveType);
        tolua_function(tolua_S,"getId",lua_cocos2dx_3d_MeshIndexData_getId);
        tolua_function(tolua_S,"getPrimitiveType",lua_cocos2dx_3d_MeshIndexData_getPrimitiveType);
        tolua_function(tolua_S,"getMeshVertexData",lua_cocos2dx_3d_MeshIndexData_getMeshVertexData);
        tolua_function(tolua_S,"getIndexBuffer",lua_cocos2dx_3d_MeshIndexData_getIndexBuffer);
        tolua_function(tolua_S,"setId",lua_cocos2dx_3d_MeshIndexData_setId);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::MeshIndexData).name();
    g_luaType[typeName] = "cc.MeshIndexData";
    g_typeCast["MeshIndexData"] = "cc.MeshIndexData";
    return 1;
}

int lua_cocos2dx_3d_MeshVertexData_getMeshVertexAttribCount(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshVertexData* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"cc.MeshVertexData",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::MeshVertexData*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshVertexData_getMeshVertexAttribCount'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshVertexData_getMeshVertexAttribCount'", nullptr);
            return 0;
        }
        ssize_t ret = cobj->getMeshVertexAttribCount();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshVertexData:getMeshVertexAttribCount",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshVertexData_getMeshVertexAttribCount'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_3d_MeshVertexData_getInitialMeshData(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshVertexData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshVertexData_getInitialMeshData'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshVertexData_getInitialMeshData'", nullptr);
            return 0;
        }
        const cocos2d::MeshData* ret = cobj->getInitialMeshData();
        #pragma warning NO CONVERSION FROM NATIVE FOR MeshData*;
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshVertexData:getInitialMeshData",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshVertexData_getInitialMeshData'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_3d_MeshVertexData_getMeshIndexDataCount(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshVertexData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshVertexData_getMeshIndexDataCount'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshVertexData_getMeshIndexDataCount'", nullptr);
            return 0;
        }
        ssize_t ret = cobj->getMeshIndexDataCount();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshVertexData:getMeshIndexDataCount",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshVertexData_getMeshIndexDataCount'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_3d_MeshVertexData_getMeshIndexDataByIndex(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshVertexData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshVertexData_getMeshIndexDataByIndex'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "cc.MeshVertexData:getMeshIndexDataByIndex");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshVertexData_getMeshIndexDataByIndex'", nullptr);
            return 0;
        }
        cocos2d::MeshIndexData* ret = cobj->getMeshIndexDataByIndex(arg0);
        object_to_luaval<cocos2d::MeshIndexData>(tolua_S, "cc.MeshIndexData",(cocos2d::MeshIndexData*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshVertexData:getMeshIndexDataByIndex",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshVertexData_getMeshIndexDataByIndex'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_3d_MeshVertexData_getVertexBuffer(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshVertexData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshVertexData_getVertexBuffer'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshVertexData_getVertexBuffer'", nullptr);
            return 0;
        }
        const cocos2d::VertexBuffer* ret = cobj->getVertexBuffer();
        object_to_luaval<cocos2d::VertexBuffer>(tolua_S, "cc.VertexBuffer",(cocos2d::VertexBuffer*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshVertexData:getVertexBuffer",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshVertexData_getVertexBuffer'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_3d_MeshVertexData_getMeshVertexAttrib(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::MeshVertexData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_MeshVertexData_getMeshVertexAttrib'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_ssize(tolua_S, 2, &arg0, "cc.MeshVertexData:getMeshVertexAttrib");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_MeshVertexData_getMeshVertexAttrib'", nullptr);
            return 0;
        }
        const cocos2d::MeshVertexAttrib& ret = cobj->getMeshVertexAttrib(arg0);
        mesh_vertex_attrib_to_luaval(tolua_S, ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshVertexData:getMeshVertexAttrib",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_MeshVertexData_getMeshVertexAttrib'.",&tolua_err);
#endif

    return 0;
}
static int lua_cocos2dx_3d_MeshVertexData_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (MeshVertexData)");
    return 0;
}

int lua_register_cocos2dx_3d_MeshVertexData(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"cc.MeshVertexData");
    tolua_cclass(tolua_S,"MeshVertexData","cc.MeshVertexData","cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,"MeshVertexData");
        tolua_function(tolua_S,"getMeshVertexAttribCount",lua_cocos2dx_3d_MeshVertexData_getMeshVertexAttribCount);
        tolua_function(tolua_S,"getInitialMeshData",lua_cocos2dx_3d_MeshVertexData_getInitialMeshData);
        tolua_function(tolua_S,"getMeshIndexDataCount",lua_cocos2dx_3d_MeshVertexData_getMeshIndexDataCount);
        tolua_function(tolua_S,"getMeshIndexDataByIndex",lua_cocos2dx_3d_MeshVertexData_getMeshIndexDataByIndex);
        tolua_function(tolua_S,"getVertexBuffer",lua_cocos2dx_3d_MeshVertexData_getVertexBuffer);
        tolua_function(tolua_S,"getMeshVertexAttrib",lua_cocos2dx_3d_MeshVertexData_getMeshVertexAttrib);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::MeshVertexData).name();
    g_luaType[typeName] = "cc.MeshVertexData";
    g_typeCast["MeshVertexData"] = "cc.MeshVertexData";
    return 1;
}
...
int lua_cocos2dx_3d_Sprite3D_addMesh(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<cocos2d::Mesh>(tolua_S, 2, "cc.Mesh",&arg0, "cc.Sprite3D:addMesh");
        if(!ok)
        {
...
int lua_cocos2dx_3d_Sprite3D_shareSkin(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::Sprite3D* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_Sprite3D_shareSkin'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<cocos2d::Sprite3D>(tolua_S, 2, "cc.Sprite3D",&arg0, "cc.Sprite3D:shareSkin");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_Sprite3D_shareSkin'", nullptr);
            return 0;
        }
        cobj->shareSkin(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.Sprite3D:shareSkin",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_Sprite3D_shareSkin'.",&tolua_err);
#endif
...
int lua_cocos2dx_3d_Sprite3D_setSkeleton(lua_State* tolua_S)
{
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_3d_Sprite3D_setSkeleton'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        cocos2d::Skeleton3D* arg0;

        ok &= luaval_to_object<cocos2d::Skeleton3D>(tolua_S, 2, "cc.Skeleton3D",&arg0, "cc.Sprite3D:setSkeleton");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_3d_Sprite3D_setSkeleton'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.Sprite3D:setSkeleton",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_3d_Sprite3D_setSkeleton'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_3d_Sprite3D(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Sprite3D");
        ...
        tolua_function(tolua_S,"shareSkin",lua_cocos2dx_3d_Sprite3D_shareSkin);
...
TOLUA_API int register_all_cocos2dx_3d(lua_State* tolua_S)
{
	...
	lua_register_cocos2dx_3d_MeshVertexData(tolua_S);
	...
	lua_register_cocos2dx_3d_MeshIndexData(tolua_S);
